...
export class MiembroMemoriaRepository implements MiembroRepository {
    private miembros: Miembro[] = [
        { id: 1, nombre: 'Angel Servin', correo: 'angel.servin@gmail.com', membresia: 'Mensual', activo: true },
        { id: 2, nombre: 'Andrea Melendrez', correo: 'andrea.melendrez@gmail.com', membresia: 'Anual', activo: true },
        { id: 3, nombre: 'Dana Chavez', correo: 'dana.chavez@gmail.com', membresia: 'Mensual', activo: false }
    ];
